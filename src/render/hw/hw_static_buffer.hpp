...
class HWStaticBuffer final {
 public:
  ...
  GPUBufferView GetTessPathVertexBufferView();

  GPUBufferView GetTessPathIndexBufferView();

  GPUBufferView GetTessPathStrokeVertexBufferView();

  GPUBufferView GetTessPathStrokeIndexBufferView();

  GPUBufferView GetTessPathAAVertexBufferView();

  GPUBufferView GetTessPathAAIndexBufferView();
 ...
 private:
  ...
  std::optional<GPUBufferView> tess_path_vertex_buffer_view_;
  std::optional<GPUBufferView> tess_path_index_buffer_view_;
  ...
  std::optional<GPUBufferView> tess_path_aa_vertex_buffer_view_;
  std::optional<GPUBufferView> tess_path_aa_index_buffer_view_;
